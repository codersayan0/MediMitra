...
@router.post("/../logout", response_model=ApiResponse[dict], include_in_schema=False)
async def _unused():
    # kept out of schema; real /api/auth/logout is defined in main.py's top-level router
    ...